...
QSqlQueryModel* Event::rechercher(QString search)
  {
      QSqlQueryModel * model=new QSqlQueryModel();

model->setQuery("SELECT * FROM EVENT where TYPE_EV like '%"+search+"%' or NOM_EV like '%"+search+"%' or DATE_EV like '%"+search+"%' or ID_EV like '%"+search+"%' or CIN_EV like '%"+search+"%' or NB_INV_EV like '%"+search+"%' ");
      ...
      model->setHeaderData(5,Qt::Horizontal, QObject::tr("NB"));
